...
options.rho = rho;
options.c = c;
options.newton_direction = newton_direction;
...
for iter = 1:T
    ...
    [x_next,lambda,converged,gt_current]=esls(x_current,x_last,gt_last,obj_hand,fi_hand,options);
